...
//calendar
$$(document).on('page:init', '.page[data-name="diario"]', function (e) {
var monthNames = ['Enero', 'Febrero', 'Marzo', 'Abril', 'Mayo', 'Junio', 'Julio', 'Agosto', 'Septiembre', 'Octubre', 'Noviembre', 'Diciembre'];
  var calendarInline = app.calendar.create({
					
        containerEl: '#calendario-content',
        value: [new Date()],
        on: {
          init: function (c) {
            $$('#calendario-head').text(monthNames[c.currentMonth] + ', ' + c.currentYear);
...
/*   Añade recordatorios */
   $$("#btnRecordatorio").on("click", fnAnadirRecordatorio)
   function fnAnadirRecordatorio (){
	   var anadirRecordatorioFecha = calendarInline.value;
	   console.log(calendarInline.value);
   }
